  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-16 text-white">
      ...
      <div className="mt-10 flex flex-wrap gap-4">
        <Link
          to="/admin/products"
          className="inline-block border border-white/20 px-6 py-3 font-mono text-xs tracking-[0.2em] text-kaif-chrome-dim hover:border-kaif-toxic hover:text-kaif-toxic"
        >
